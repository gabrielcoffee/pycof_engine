from graphics.sprite_background import BackgroundSprite
from scenes.scene import Scene
from tiles.world_levels import WorldLevels
...
class PlayScene(Scene):
    def init(self, map_index):
        ...
        # Level backgrounds
        self.backgrounds = []
        self.backgrounds.append(BackgroundSprite(resourceManager.getTexture('backg'), 100, 'x'))
